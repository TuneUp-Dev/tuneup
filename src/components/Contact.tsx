  ...
  return (
    <>
      <div className="w-full my-28 px-28">
        <span className="bg-slate-100 rounded-xl px-3 py-2 text-[#021734] text-[13px] font-semibold uppercase">
          Contact us
        </span>
        <div className="flex justify-between items-start gap-12">
          <div className="w-full flex flex-col justify-between mt-4 items-start">
            <div>
              <p className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-[#2c4464] to-[#021734] text-[52px] w-full leading-[60px] inter-bold">
                Let’s work together
              </p>
            </div>
          ...
          <div className="relative w-full h-[300px] flex justify-end items-start brightness-[90%]">
            <Lottie
              loop
