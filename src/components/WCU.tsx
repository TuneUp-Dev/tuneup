      ...
      <div className="bg-[#021734]">
        <div className="bg-white shadow-[0px_-25px_50px_-30px_#020810] rounded-t-[40px] md:rounded-t-[70px]">
          <div className="w-[90vw] max-w-[1440px] mx-auto lg:w-full lg:px-16 xl:px-28 pt-14 md:pt-20">
            ...
            <p className="bg-clip-text flex justify-start items-center text-nowrap text-transparent bg-gradient-to-r from-blue-500 via-[#2c4464] to-[#021734] text-[40px] lg:text-[52px] lg:w-[800px] leading-[41px] lg:leading-[60px] mt-4 inter-bold">
              Choose TuneUp,{" "}
