  ...
  return (
    <>
      <div className="w-full px-28">
        ...
        <p className="mt-5 text-[20px]">At TuneUp Technologies, we are more than just a software 
...
us:</p>
        <div className="mt-14 w-full h-[200px] flex justify-between items-center gap-7">
          <div className="w-full h-full bg-blue-50 rounded-2xl flex justify-between items-start p-5 gap-x-5">
            ...
            <div className="">
              <h1 className="font-semibold text-[20px]">Expertise and Innovation </h1>
              <p className="mt-2 text-slate-700">
              Our team of skilled professionals stays ahead of industry trends, 
delivering cutting-edge solutions tailored to your unique needs.
              </p>
            </div>
          </div>
          <div className="w-full h-full bg-blue-50 rounded-2xl flex justify-between items-start p-5 gap-x-5">
            ...
            <div className="">
              ...
              <p className="mt-2 text-slate-700">
              We understand that every business is different. Our solutions are 
personalized to align with your goals and drive measurable success. 
              </p>
            </div>
          </div>
          <div className="w-full h-full bg-blue-50 rounded-2xl flex justify-between items-start p-5 gap-x-5">
