...
const WCU = () => {
  return (
    <>
      <div className="w-[90vw] mx-auto lg:w-full lg:px-28 pt-20">
        <span className="bg-slate-100 rounded-lg px-3 py-2 text-[#021734] text-[11.5px] lg:text-[13px] font-semibold uppercase">
          Why choose us
        </span>
        <p className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-[#2c4464] to-[#021734] text-[40px] lg:text-[52px] lg:w-[700px] leading-[44px] lg:leading-[60px] mt-4 inter-bold">
        ...
        <p className="mt-4 lg:mt-5 lg:w-[900px] text-[14px] lg:text-[17px]">
        ...
        <div className="mt-10 lg:mt-14 w-full h-auto lg:h-[200px] flex flex-col lg:flex-row justify-between items-center gap-y-5 gap-x-7">
          <div className="w-full h-full bg-blue-50 rounded-2xl flex justify-between items-start p-4 lg:p-5 gap-x-4 lg:gap-x-5">
            <img className="w-7 lg:w-9" src={Verified} alt="" />
            <div className="">
              <h1 className="font-semibold text-[16.5px] lg:text-[20px]">
                Expertise and Innovation{" "}
              </h1>
              <p className="mt-2 lg:mt-3 text-slate-700 text-[14px] lg:text-[17px]">
